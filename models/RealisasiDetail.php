...
/**
 * This is the model class for table "realisasi_detail".
 *
 * @property int $tahun
...
class RealisasiDetail extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['tahun', 'id_unit', 'id_skpd', 'kode_skpd', 'nama_skpd', 'id_urusan', 'kode_urusan', 'nama_urusan', 'id_bidang_urusan', 'kode_bidang_urusan', 'nama_bidang_urusan', 'id_sub_skpd', 'kode_sub_skpd', 'nama_sub_skpd', 'id_program', 'kode_program', 'nama_program', 'id_giat', 'kode_giat', 'nama_giat', 'id_sub_giat', 'kode_sub_giat', 'nama_sub_giat', 'id_akun', 'kode_akun', 'nama_akun', 'rincian', 'LEN', 'id_skpd_id_sub_skpd_id_sub_giat_id_akun', 'jlh_realisasi', 'kode_jenis', 'nama_jenis', 'no_dokumen', 'ket_dokumen', 'tgl_dokumen', 'realisasi'], 'required'],
            [['tahun', 'id_unit', 'id_skpd', 'id_urusan', 'id_bidang_urusan', 'id_sub_skpd', 'id_program', 'id_giat', 'id_sub_giat', 'id_akun'], 'integer'],
            [['kode_skpd', 'nama_skpd', 'kode_urusan', 'nama_urusan', 'kode_bidang_urusan', 'nama_bidang_urusan', 'kode_sub_skpd', 'nama_sub_skpd', 'kode_program', 'nama_program', 'kode_giat', 'nama_giat', 'kode_sub_giat', 'nama_sub_giat', 'kode_akun', 'nama_akun', 'LEN', 'id_skpd_id_sub_skpd_id_sub_giat_id_akun', 'kode_jenis', 'nama_jenis', 'no_dokumen', 'ket_dokumen'], 'safe'],
            [['rincian', 'jlh_realisasi', 'realisasi'], 'number'],
            [['tgl_dokumen'], 'safe'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'jlh_realisasi' => 'Jlh Realisasi',
            'kode_jenis' => 'Kode Jenis',
            'nama_jenis' => 'Nama Jenis',
            'no_dokumen' => 'No Dokumen',
            'ket_dokumen' => 'Ket Dokumen',
